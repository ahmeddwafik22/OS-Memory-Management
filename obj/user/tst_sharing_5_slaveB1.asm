...
_main(void)
{
  ...
  80009f:	68 d9 22 80 00       	push   $0x8022d9
  8000a4:	50                   	push   %eax
  ...
  8000f9:	68 24 23 80 00       	push   $0x802324
  ...
  80011c:	68 3c 23 80 00       	push   $0x80233c
...
libmain(int argc, char **argv)
{
  ...
  8001e6:	52                   	push   %edx
  8001e7:	50                   	push   %eax
  8001e8:	68 24 24 80 00       	push   $0x802424
  ...
  80020e:	52                   	push   %edx
  80020f:	50                   	push   %eax
  800210:	68 4c 24 80 00       	push   $0x80244c
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029a:	50                   	push   %eax
  80029b:	68 a4 24 80 00       	push   $0x8024a4
  ...
  8002b3:	50                   	push   %eax
  8002b4:	68 a9 24 80 00       	push   $0x8024a9
  ...
  8002d8:	68 c5 24 80 00       	push   $0x8024c5
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800304:	68 c8 24 80 00       	push   $0x8024c8
  800309:	6a 26                	push   $0x26
  80030b:	68 14 25 80 00       	push   $0x802514
  ...
  8003ca:	68 20 25 80 00       	push   $0x802520
  8003cf:	6a 3a                	push   $0x3a
  8003d1:	68 14 25 80 00       	push   $0x802514
  ...
  800434:	68 74 25 80 00       	push   $0x802574
  800439:	6a 44                	push   $0x44
  80043b:	68 14 25 80 00       	push   $0x802514
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800611:	05 d4 27 80 00       	add    $0x8027d4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800764:	8b 04 85 f8 27 80 00 	mov    0x8027f8(,%eax,4),%eax
  ...
  800845:	8b 34 9d 40 26 80 00 	mov    0x802640(,%ebx,4),%esi
  80084c:	85 f6                	test   %esi,%esi
  80084e:	75 19                	jne    800869 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800850:	53                   	push   %ebx
  800851:	68 e5 27 80 00       	push   $0x8027e5
  ...
  800864:	e9 49 02 00 00       	jmp    800ab2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800869:	56                   	push   %esi
  80086a:	68 ee 27 80 00       	push   $0x8027ee
  ...
  800895:	75 05                	jne    80089c <vprintfmt+0x1a6>
				p = "(null)";
  800897:	be f1 27 80 00       	mov    $0x8027f1,%esi
			if (width > 0 && padc != '-')
...
//	while(size%PAGE_SIZE!=0){
  ...
  801301:	68 50 29 80 00       	push   $0x802950
  ...
  80131f:	68 65 29 80 00       	push   $0x802965
  ...
  8016c2:	68 50 29 80 00       	push   $0x802950
  ...
  8016e9:	68 65 29 80 00       	push   $0x802965
  ...
  801710:	68 78 29 80 00       	push   $0x802978
  ...
  80173e:	50                   	push   %eax
  80173f:	68 8c 29 80 00       	push   $0x80298c
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80184f:	68 a8 29 80 00       	push   $0x8029a8
  801854:	68 18 01 00 00       	push   $0x118
  801859:	68 cb 29 80 00       	push   $0x8029cb
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  80186c:	68 a8 29 80 00       	push   $0x8029a8
  801871:	68 1e 01 00 00       	push   $0x11e
  801876:	68 cb 29 80 00       	push   $0x8029cb
...
void sfree(void* virtual_address)
{
  ...
  801889:	68 a8 29 80 00       	push   $0x8029a8
  80188e:	68 24 01 00 00       	push   $0x124
  801893:	68 cb 29 80 00       	push   $0x8029cb
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8018a6:	68 a8 29 80 00       	push   $0x8029a8
  8018ab:	68 29 01 00 00       	push   $0x129
  8018b0:	68 cb 29 80 00       	push   $0x8029cb
...
void expand(uint32 newSize)
{
  ...
  8018c3:	68 a8 29 80 00       	push   $0x8029a8
  8018c8:	68 2f 01 00 00       	push   $0x12f
  8018cd:	68 cb 29 80 00       	push   $0x8029cb
...
void shrink(uint32 newSize)
{
  ...
  8018e0:	68 a8 29 80 00       	push   $0x8029a8
  8018e5:	68 33 01 00 00       	push   $0x133
  8018ea:	68 cb 29 80 00       	push   $0x8029cb
...
void freeHeap(void* virtual_address)
{
  ...
  8018fd:	68 a8 29 80 00       	push   $0x8029a8
  801902:	68 38 01 00 00       	push   $0x138
  801907:	68 cb 29 80 00       	push   $0x8029cb
