...
void _main(void)
{
  ...
  800049:	e8 e8 20 00 00       	call   802136 <sys_getenvid>
  80004e:	89 45 e8             	mov    %eax,-0x18(%ebp)
	sys_createSemaphore("1", 1);
  800051:	83 ec 08             	sub    $0x8,%esp
  800054:	6a 01                	push   $0x1
  800056:	68 80 29 80 00       	push   $0x802980
  80005b:	e8 fe 22 00 00       	call   80235e <sys_createSemaphore>
  800060:	83 c4 10             	add    $0x10,%esp
	do
	{
		int InitFreeFrames = sys_calculate_free_frames() + sys_calculate_modified_frames();
  800063:	e8 b2 21 00 00       	call   80221a <sys_calculate_free_frames>
  800068:	89 c3                	mov    %eax,%ebx
  80006a:	e8 c4 21 00 00       	call   802233 <sys_calculate_modified_frames>
...
//	sys_disable_interrupt();
  ...
  800082:	e8 10 23 00 00       	call   802397 <sys_waitSemaphore>
  800087:	83 c4 10             	add    $0x10,%esp
		readline("Enter the number of elements: ", Line);
  80008a:	83 ec 08             	sub    $0x8,%esp
  80008d:	8d 85 38 9c ff ff    	lea    -0x63c8(%ebp),%eax
  800093:	50                   	push   %eax
  800094:	68 84 29 80 00       	push   $0x802984
  ...
  8000d2:	68 a4 29 80 00       	push   $0x8029a4
  8000d7:	e8 d7 09 00 00       	call   800ab3 <cprintf>
  8000dc:	83 c4 10             	add    $0x10,%esp
		cprintf("a) Ascending\n") ;
  8000df:	83 ec 0c             	sub    $0xc,%esp
  8000e2:	68 c7 29 80 00       	push   $0x8029c7
  ...
  80017b:	68 80 29 80 00       	push   $0x802980
  800180:	ff 75 e8             	pushl  -0x18(%ebp)
  800183:	e8 2d 22 00 00       	call   8023b5 <sys_signalSemaphore>
  ...
  80021d:	68 22 2a 80 00       	push   $0x802a22
  800222:	e8 ea 05 00 00       	call   800811 <_panic>
		else
		{
			sys_waitSemaphore(envID, "1");
  800227:	83 ec 08             	sub    $0x8,%esp
  80022a:	68 80 29 80 00       	push   $0x802980
  80022f:	ff 75 e8             	pushl  -0x18(%ebp)
  800232:	e8 60 21 00 00       	call   802397 <sys_waitSemaphore>
  800237:	83 c4 10             	add    $0x10,%esp
			cprintf("\n===============================================\n") ;
  80023a:	83 ec 0c             	sub    $0xc,%esp
  80023d:	68 34 2a 80 00       	push   $0x802a34
  800242:	e8 6c 08 00 00       	call   800ab3 <cprintf>
  800247:	83 c4 10             	add    $0x10,%esp
			cprintf("Congratulations!! The array is sorted correctly\n") ;
  80024a:	83 ec 0c             	sub    $0xc,%esp
  80024d:	68 68 2a 80 00       	push   $0x802a68
  800252:	e8 5c 08 00 00       	call   800ab3 <cprintf>
  800257:	83 c4 10             	add    $0x10,%esp
			cprintf("===============================================\n\n") ;
  80025a:	83 ec 0c             	sub    $0xc,%esp
  80025d:	68 9c 2a 80 00       	push   $0x802a9c
  800262:	e8 4c 08 00 00       	call   800ab3 <cprintf>
  800267:	83 c4 10             	add    $0x10,%esp
			sys_signalSemaphore(envID, "1");
  80026a:	83 ec 08             	sub    $0x8,%esp
  80026d:	68 80 29 80 00       	push   $0x802980
  800272:	ff 75 e8             	pushl  -0x18(%ebp)
  800275:	e8 3b 21 00 00       	call   8023b5 <sys_signalSemaphore>
  ...
  800280:	68 80 29 80 00       	push   $0x802980
  800285:	ff 75 e8             	pushl  -0x18(%ebp)
  800288:	e8 0a 21 00 00       	call   802397 <sys_waitSemaphore>
  80028d:	83 c4 10             	add    $0x10,%esp
		cprintf("Freeing the Heap...\n\n") ;
  800290:	83 ec 0c             	sub    $0xc,%esp
  800293:	68 ce 2a 80 00       	push   $0x802ace
  800298:	e8 16 08 00 00       	call   800ab3 <cprintf>
  80029d:	83 c4 10             	add    $0x10,%esp
		sys_signalSemaphore(envID,"1");
  8002a0:	83 ec 08             	sub    $0x8,%esp
  8002a3:	68 80 29 80 00       	push   $0x802980
  8002a8:	ff 75 e8             	pushl  -0x18(%ebp)
  8002ab:	e8 05 21 00 00       	call   8023b5 <sys_signalSemaphore>
  8002b0:	83 c4 10             	add    $0x10,%esp
		free(Elements) ;
  8002b3:	83 ec 0c             	sub    $0xc,%esp
  8002b6:	ff 75 dc             	pushl  -0x24(%ebp)
  8002b9:	e8 40 1c 00 00       	call   801efe <free>
  ...
  8002c4:	68 80 29 80 00       	push   $0x802980
  8002c9:	ff 75 e8             	pushl  -0x18(%ebp)
  8002cc:	e8 c6 20 00 00       	call   802397 <sys_waitSemaphore>
  8002d1:	83 c4 10             	add    $0x10,%esp
		cprintf("Do you want to repeat (y/n): ") ;
  8002d4:	83 ec 0c             	sub    $0xc,%esp
  8002d7:	68 e4 2a 80 00       	push   $0x802ae4
  ...
  800319:	68 80 29 80 00       	push   $0x802980
  80031e:	ff 75 e8             	pushl  -0x18(%ebp)
  800321:	e8 8f 20 00 00       	call   8023b5 <sys_signalSemaphore>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  8005cc:	68 02 2b 80 00       	push   $0x802b02
  ...
  8005ed:	50                   	push   %eax
  8005ee:	68 04 2b 80 00       	push   $0x802b04
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  80061b:	50                   	push   %eax
  80061c:	68 09 2b 80 00       	push   $0x802b09
...
cputchar(int ch)
{
  ...
  80063f:	50                   	push   %eax
  800640:	e8 d9 1c 00 00       	call   80231e <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  80064e:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800651:	e8 94 1c 00 00       	call   8022ea <sys_disable_interrupt>
	char c = ch;
  ...
  800663:	50                   	push   %eax
  800664:	e8 b5 1c 00 00       	call   80231e <sys_cputc>
  800669:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  80066c:	e8 93 1c 00 00       	call   802304 <sys_enable_interrupt>
}
  800671:	90                   	nop
  800672:	c9                   	leave  
  800673:	c3                   	ret    
...
getchar(void)
{
  ...
  800681:	eb 08                	jmp    80068b <getchar+0x17>
	{
		c = sys_cgetc();
  800683:	e8 7a 1a 00 00       	call   802102 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800699:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80069c:	e8 49 1c 00 00       	call   8022ea <sys_disable_interrupt>
	int c=0;
  ...
  8006a8:	eb 08                	jmp    8006b2 <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  8006aa:	e8 53 1a 00 00       	call   802102 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8006b6:	74 f2                	je     8006aa <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  8006b8:	e8 47 1c 00 00       	call   802304 <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  8006d2:	e8 78 1a 00 00       	call   80214f <sys_getenvindex>
  ...
  80070b:	a3 24 40 80 00       	mov    %eax,0x804024

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  800710:	a1 24 40 80 00       	mov    0x804024,%eax
  800715:	8a 80 40 3c 01 00    	mov    0x13c40(%eax),%al
  80071b:	84 c0                	test   %al,%al
  80071d:	74 0f                	je     80072e <libmain+0x62>
		binaryname = myEnv->prog_name;
  80071f:	a1 24 40 80 00       	mov    0x804024,%eax
  800724:	05 40 3c 01 00       	add    $0x13c40,%eax
  800729:	a3 00 40 80 00       	mov    %eax,0x804000
  ...
  800739:	a3 00 40 80 00       	mov    %eax,0x804000
  ...
  8007c2:	50                   	push   %eax
  8007c3:	68 b9 2b 80 00       	push   $0x802bb9
  8007c8:	e8 e6 02 00 00       	call   800ab3 <cprintf>
  8007cd:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8007d0:	83 ec 0c             	sub    $0xc,%esp
  8007d3:	68 28 2b 80 00       	push   $0x802b28
  8007d8:	e8 d6 02 00 00       	call   800ab3 <cprintf>
  8007dd:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8007e0:	e8 1f 1b 00 00       	call   802304 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8007f8:	e8 1e 19 00 00       	call   80211b <sys_env_destroy>
...
exit(void)
{
  ...
  800806:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800809:	e8 73 19 00 00       	call   802181 <sys_env_exit>
}
  80080e:	90                   	nop
  80080f:	c9                   	leave  
  800810:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80081d:	89 45 f4             	mov    %eax,-0xc(%ebp)
	...
	if (argv0)
  800820:	a1 18 41 80 00       	mov    0x804118,%eax
  800825:	85 c0                	test   %eax,%eax
  800827:	74 16                	je     80083f <_panic+0x2e>
		cprintf("%s: ", argv0);
  800829:	a1 18 41 80 00       	mov    0x804118,%eax
  80082e:	83 ec 08             	sub    $0x8,%esp
  800831:	50                   	push   %eax
  800832:	68 d0 2b 80 00       	push   $0x802bd0
  800837:	e8 77 02 00 00       	call   800ab3 <cprintf>
  80083c:	83 c4 10             	add    $0x10,%esp
	cprintf("user panic in %s at %s:%d: ", binaryname, file, line);
  80083f:	a1 00 40 80 00       	mov    0x804000,%eax
  800844:	ff 75 0c             	pushl  0xc(%ebp)
  800847:	ff 75 08             	pushl  0x8(%ebp)
  80084a:	50                   	push   %eax
  80084b:	68 d5 2b 80 00       	push   $0x802bd5
  ...
  80086f:	68 f1 2b 80 00       	push   $0x802bf1
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80089b:	68 f4 2b 80 00       	push   $0x802bf4
  8008a0:	6a 26                	push   $0x26
  8008a2:	68 40 2c 80 00       	push   $0x802c40
  ...
  8008ec:	a1 24 40 80 00       	mov    0x804024,%eax
  ...
  800949:	a1 24 40 80 00       	mov    0x804024,%eax
  ...
  800961:	68 4c 2c 80 00       	push   $0x802c4c
  800966:	6a 3a                	push   $0x3a
  800968:	68 40 2c 80 00       	push   $0x802c40
  ...
  800991:	a1 24 40 80 00       	mov    0x804024,%eax
  ...
  8009b1:	a1 24 40 80 00       	mov    0x804024,%eax
  ...
  8009cb:	68 a0 2c 80 00       	push   $0x802ca0
  8009d0:	6a 44                	push   $0x44
  8009d2:	68 40 2c 80 00       	push   $0x802c40
...
static void putch(int ch, struct printbuf *b) {
  ...
  800a0a:	a0 28 40 80 00       	mov    0x804028,%al
  ...
  800a23:	51                   	push   %ecx
  800a24:	52                   	push   %edx
  800a25:	e8 af 16 00 00       	call   8020d9 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800a7c:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName);
  800a7f:	a0 28 40 80 00       	mov    0x804028,%al
  ...
  800a9b:	50                   	push   %eax
  800a9c:	e8 38 16 00 00       	call   8020d9 <sys_cputs>
  800aa1:	83 c4 10             	add    $0x10,%esp

	printProgName = 0;
  800aa4:	c6 05 28 40 80 00 00 	movb   $0x0,0x804028
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  800ab6:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800ab9:	c6 05 28 40 80 00 01 	movb   $0x1,0x804028
	va_start(ap, fmt);
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800ae3:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800ae6:	e8 ff 17 00 00       	call   8022ea <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800b03:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800b06:	e8 f9 17 00 00       	call   802304 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800b50:	e8 b7 1b 00 00       	call   80270c <__udivdi3>
  ...
  800b9e:	52                   	push   %edx
  800b9f:	50                   	push   %eax
  800ba0:	e8 77 1c 00 00       	call   80281c <__umoddi3>
  800ba5:	83 c4 10             	add    $0x10,%esp
  800ba8:	05 14 2f 80 00       	add    $0x802f14,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800cfb:	8b 04 85 38 2f 80 00 	mov    0x802f38(,%eax,4),%eax
  ...
  800ddc:	8b 34 9d 80 2d 80 00 	mov    0x802d80(,%ebx,4),%esi
  800de3:	85 f6                	test   %esi,%esi
  800de5:	75 19                	jne    800e00 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800de7:	53                   	push   %ebx
  800de8:	68 25 2f 80 00       	push   $0x802f25
  ...
  800dfb:	e9 49 02 00 00       	jmp    801049 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800e00:	56                   	push   %esi
  800e01:	68 2e 2f 80 00       	push   $0x802f2e
  ...
  800e2c:	75 05                	jne    800e33 <vprintfmt+0x1a6>
				p = "(null)";
  800e2e:	be 31 2f 80 00       	mov    $0x802f31,%esi
			if (width > 0 && padc != '-')
...
void readline(const char *prompt, char* buf)
{
  ...
  801147:	68 90 30 80 00       	push   $0x803090
  ...
  801189:	68 93 30 80 00       	push   $0x803093
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  801236:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801239:	e8 ac 10 00 00       	call   8022ea <sys_disable_interrupt>
	int i, c, echoing;
  ...
  80124a:	68 90 30 80 00       	push   $0x803090
  ...
  801288:	68 93 30 80 00       	push   $0x803093
  80128d:	e8 21 f8 ff ff       	call   800ab3 <cprintf>
  801292:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  801295:	e8 6a 10 00 00       	call   802304 <sys_enable_interrupt>
			return;
  ...
  80132a:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  80132d:	e8 d2 0f 00 00       	call   802304 <sys_enable_interrupt>
			return;
...
//	while(size%PAGE_SIZE!=0){
  ...
  801a49:	c7 45 ac 00 10 00 00 	movl   $0x1000,-0x54(%ebp)
  801a50:	8b 55 08             	mov    0x8(%ebp),%edx
  801a53:	8b 45 ac             	mov    -0x54(%ebp),%eax
  801a56:	01 d0                	add    %edx,%eax
  801a58:	48                   	dec    %eax
  801a59:	89 45 a8             	mov    %eax,-0x58(%ebp)
  801a5c:	8b 45 a8             	mov    -0x58(%ebp),%eax
  801a5f:	ba 00 00 00 00       	mov    $0x0,%edx
  801a64:	f7 75 ac             	divl   -0x54(%ebp)
  801a67:	8b 45 a8             	mov    -0x58(%ebp),%eax
  801a6a:	29 d0                	sub    %edx,%eax
  801a6c:	89 45 08             	mov    %eax,0x8(%ebp)
  ...
  801a6f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	...
	int flag1=0;
  801a76:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

	int ni= PAGE_SIZE;
  801a7d:	c7 45 ec 00 10 00 00 	movl   $0x1000,-0x14(%ebp)

	for(int i=0;i<count;i++){
  801a84:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  801a8b:	eb 3f                	jmp    801acc <malloc+0x89>

		cprintf("arr %d start is: %x\n",i,arr_add[i].start);
  801a8d:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801a90:	8b 04 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%eax
  801a97:	83 ec 04             	sub    $0x4,%esp
  801a9a:	50                   	push   %eax
  801a9b:	ff 75 e8             	pushl  -0x18(%ebp)
  801a9e:	68 a4 30 80 00       	push   $0x8030a4
  801aa3:	e8 0b f0 ff ff       	call   800ab3 <cprintf>
  801aa8:	83 c4 10             	add    $0x10,%esp
		cprintf("arr %d end is: %x\n",i,arr_add[i].end);
  801aab:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801aae:	8b 04 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%eax
  801ab5:	83 ec 04             	sub    $0x4,%esp
  801ab8:	50                   	push   %eax
  801ab9:	ff 75 e8             	pushl  -0x18(%ebp)
  801abc:	68 b9 30 80 00       	push   $0x8030b9
  801ac1:	e8 ed ef ff ff       	call   800ab3 <cprintf>
  801ac6:	83 c4 10             	add    $0x10,%esp
	...
	for(int i=0;i<count;i++){
  801ac9:	ff 45 e8             	incl   -0x18(%ebp)
  801acc:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801ad1:	39 45 e8             	cmp    %eax,-0x18(%ebp)
  801ad4:	7c b7                	jl     801a8d <malloc+0x4a>
  ...
  801ad6:	c7 45 e4 00 00 00 80 	movl   $0x80000000,-0x1c(%ebp)
  801add:	e9 42 01 00 00       	jmp    801c24 <malloc+0x1e1>
		int flag0=1;
  801ae2:	c7 45 e0 01 00 00 00 	movl   $0x1,-0x20(%ebp)
		for(int j=i;j<i+size;j+=PAGE_SIZE){
  801ae9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801aec:	89 45 dc             	mov    %eax,-0x24(%ebp)
  801aef:	eb 6b                	jmp    801b5c <malloc+0x119>
			for(int k=0;k<count;k++){
  801af1:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
  801af8:	eb 42                	jmp    801b3c <malloc+0xf9>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
  801afa:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801afd:	8b 14 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%edx
  801b04:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b07:	39 c2                	cmp    %eax,%edx
  801b09:	77 2e                	ja     801b39 <malloc+0xf6>
  801b0b:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801b0e:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  801b15:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b18:	39 c2                	cmp    %eax,%edx
  801b1a:	76 1d                	jbe    801b39 <malloc+0xf6>
					ni=arr_add[k].end-i;
  801b1c:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801b1f:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  801b26:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801b29:	29 c2                	sub    %eax,%edx
  801b2b:	89 d0                	mov    %edx,%eax
  801b2d:	89 45 ec             	mov    %eax,-0x14(%ebp)
					flag1=1;
  801b30:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
					break;
  801b37:	eb 0d                	jmp    801b46 <malloc+0x103>
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		...
		for(int j=i;j<i+size;j+=PAGE_SIZE){
			for(int k=0;k<count;k++){
  801b39:	ff 45 d8             	incl   -0x28(%ebp)
  801b3c:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801b41:	39 45 d8             	cmp    %eax,-0x28(%ebp)
  801b44:	7c b4                	jl     801afa <malloc+0xb7>
					ni=arr_add[k].end-i;
					flag1=1;
					break;
				}
			...
			if(flag1){
  801b46:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801b4a:	74 09                	je     801b55 <malloc+0x112>
				flag0=0;
  801b4c:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
				break;
  801b53:	eb 16                	jmp    801b6b <malloc+0x128>
		cprintf("arr %d end is: %x\n",i,arr_add[i].end);
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		int flag0=1;
		for(int j=i;j<i+size;j+=PAGE_SIZE){
  801b55:	81 45 dc 00 10 00 00 	addl   $0x1000,-0x24(%ebp)
  801b5c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b5f:	8b 45 08             	mov    0x8(%ebp),%eax
  801b62:	01 c2                	add    %eax,%edx
  801b64:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b67:	39 c2                	cmp    %eax,%edx
  801b69:	77 86                	ja     801af1 <malloc+0xae>
			if(flag1){
				flag0=0;
				break;
			}
		...
		if(flag0){
  801b6b:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  801b6f:	0f 84 a2 00 00 00    	je     801c17 <malloc+0x1d4>

			int f=1;
  801b75:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)

			arr[count2].start=i;
  801b7c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b7f:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801b82:	89 c8                	mov    %ecx,%eax
  801b84:	01 c0                	add    %eax,%eax
  801b86:	01 c8                	add    %ecx,%eax
  801b88:	c1 e0 02             	shl    $0x2,%eax
  801b8b:	05 20 41 80 00       	add    $0x804120,%eax
  801b90:	89 10                	mov    %edx,(%eax)
			arr[count2].end = i+size;
  801b92:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b95:	8b 45 08             	mov    0x8(%ebp),%eax
  801b98:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
  ...
  801ba7:	05 24 41 80 00       	add    $0x804124,%eax
  ...
  801bb7:	c1 e0 02             	shl    $0x2,%eax
  801bba:	05 28 41 80 00       	add    $0x804128,%eax
  801bbf:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			count2++;
  801bc5:	ff 45 f4             	incl   -0xc(%ebp)

			for(int l=0;l<count;l++){
  801bc8:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%ebp)
  801bcf:	eb 36                	jmp    801c07 <malloc+0x1c4>
				if(i+size<arr_add[l].start){
  801bd1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801bd4:	8b 45 08             	mov    0x8(%ebp),%eax
  801bd7:	01 c2                	add    %eax,%edx
  801bd9:	8b 45 d0             	mov    -0x30(%ebp),%eax
  801bdc:	8b 04 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%eax
  801be3:	39 c2                	cmp    %eax,%edx
  801be5:	73 1d                	jae    801c04 <malloc+0x1c1>
					ni=arr_add[l].end-i;
  801be7:	8b 45 d0             	mov    -0x30(%ebp),%eax
  801bea:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  801bf1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801bf4:	29 c2                	sub    %eax,%edx
  801bf6:	89 d0                	mov    %edx,%eax
  801bf8:	89 45 ec             	mov    %eax,-0x14(%ebp)
					f=0;
  801bfb:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					break;
  801c02:	eb 0d                	jmp    801c11 <malloc+0x1ce>
			arr[count2].start=i;
			arr[count2].end = i+size;
			arr[count2].space=0;
			count2++;
			...
			for(int l=0;l<count;l++){
  801c04:	ff 45 d0             	incl   -0x30(%ebp)
  801c07:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801c0c:	39 45 d0             	cmp    %eax,-0x30(%ebp)
  801c0f:	7c c0                	jl     801bd1 <malloc+0x18e>
					break;
			...
			if(f){
  801c11:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  801c15:	75 1d                	jne    801c34 <malloc+0x1f1>
				break;
			}
  ...
  801c21:	01 45 e4             	add    %eax,-0x1c(%ebp)
  801c24:	a1 04 40 80 00       	mov    0x804004,%eax
  801c29:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801c2c:	0f 8c b0 fe ff ff    	jl     801ae2 <malloc+0x9f>
  801c32:	eb 01                	jmp    801c35 <malloc+0x1f2>
  ...
  801c34:	90                   	nop
	...
	if(count2==0){
  801c35:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801c39:	75 7a                	jne    801cb5 <malloc+0x272>
		//cprintf("hellllllllOOlooo");
		if((int)(base_add+size-1)>=(int)USER_HEAP_MAX)
  801c3b:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801c41:	8b 45 08             	mov    0x8(%ebp),%eax
  801c44:	01 d0                	add    %edx,%eax
  801c46:	48                   	dec    %eax
  801c47:	3d 00 00 00 a0       	cmp    $0xa0000000,%eax
  801c4c:	7c 0a                	jl     801c58 <malloc+0x215>
			return NULL;
  801c4e:	b8 00 00 00 00       	mov    $0x0,%eax
  801c53:	e9 a4 02 00 00       	jmp    801efc <malloc+0x4b9>
		else{
			uint32 s=base_add;
  801c58:	a1 04 40 80 00       	mov    0x804004,%eax
  801c5d:	89 45 a4             	mov    %eax,-0x5c(%ebp)
			//cprintf("s: %x",s);
			arr_add[count].start=s;
  801c60:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801c65:	8b 55 a4             	mov    -0x5c(%ebp),%edx
  801c68:	89 14 c5 e0 15 82 00 	mov    %edx,0x8215e0(,%eax,8)
		    sys_allocateMem(s,size);
  801c6f:	83 ec 08             	sub    $0x8,%esp
  801c72:	ff 75 08             	pushl  0x8(%ebp)
  801c75:	ff 75 a4             	pushl  -0x5c(%ebp)
  801c78:	e8 04 06 00 00       	call   802281 <sys_allocateMem>
  ...
  801c8b:	a3 04 40 80 00       	mov    %eax,0x804004
			arr_add[count].end=base_add;
  801c90:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801c95:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801c9b:	89 14 c5 e4 15 82 00 	mov    %edx,0x8215e4(,%eax,8)
			count++;
  801ca2:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801ca7:	40                   	inc    %eax
  801ca8:	a3 2c 40 80 00       	mov    %eax,0x80402c

			return (void*)s;
  801cad:	8b 45 a4             	mov    -0x5c(%ebp),%eax
  801cb0:	e9 47 02 00 00       	jmp    801efc <malloc+0x4b9>
	}
	else{
  ...
  801cb5:	c7 45 cc 00 00 00 00 	movl   $0x0,-0x34(%ebp)
  801cbc:	e9 ac 00 00 00       	jmp    801d6d <malloc+0x32a>
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801cc1:	8b 55 cc             	mov    -0x34(%ebp),%edx
  ...
  801cd4:	89 45 c8             	mov    %eax,-0x38(%ebp)
  801cd7:	eb 7e                	jmp    801d57 <malloc+0x314>
			int flag=0;
  801cd9:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
			for(int k=0;k<count;k++){
  801ce0:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
  801ce7:	eb 57                	jmp    801d40 <malloc+0x2fd>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
  801ce9:	8b 45 c0             	mov    -0x40(%ebp),%eax
  801cec:	8b 14 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%edx
  801cf3:	8b 45 c8             	mov    -0x38(%ebp),%eax
  801cf6:	39 c2                	cmp    %eax,%edx
  801cf8:	77 1a                	ja     801d14 <malloc+0x2d1>
  801cfa:	8b 45 c0             	mov    -0x40(%ebp),%eax
  801cfd:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  801d04:	8b 45 c8             	mov    -0x38(%ebp),%eax
  801d07:	39 c2                	cmp    %eax,%edx
  801d09:	76 09                	jbe    801d14 <malloc+0x2d1>
								flag=1;
  801d0b:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
								break;}
  801d12:	eb 36                	jmp    801d4a <malloc+0x307>
			arr[i].space++;
  801d14:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801d17:	89 d0                	mov    %edx,%eax
  801d19:	01 c0                	add    %eax,%eax
  801d1b:	01 d0                	add    %edx,%eax
  801d1d:	c1 e0 02             	shl    $0x2,%eax
  801d20:	05 28 41 80 00       	add    $0x804128,%eax
  801d25:	8b 00                	mov    (%eax),%eax
  801d27:	8d 48 01             	lea    0x1(%eax),%ecx
  801d2a:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801d2d:	89 d0                	mov    %edx,%eax
  801d2f:	01 c0                	add    %eax,%eax
  801d31:	01 d0                	add    %edx,%eax
  801d33:	c1 e0 02             	shl    $0x2,%eax
  801d36:	05 28 41 80 00       	add    $0x804128,%eax
  801d3b:	89 08                	mov    %ecx,(%eax)
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
			int flag=0;
			for(int k=0;k<count;k++){
  801d3d:	ff 45 c0             	incl   -0x40(%ebp)
  801d40:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801d45:	39 45 c0             	cmp    %eax,-0x40(%ebp)
  801d48:	7c 9f                	jl     801ce9 <malloc+0x2a6>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
								flag=1;
								break;}
			arr[i].space++;
			...
			if(flag)
  801d4a:	83 7d c4 00          	cmpl   $0x0,-0x3c(%ebp)
  801d4e:	75 19                	jne    801d69 <malloc+0x326>
	else{
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801d50:	81 45 c8 00 10 00 00 	addl   $0x1000,-0x38(%ebp)
  801d57:	8b 55 c8             	mov    -0x38(%ebp),%edx
  801d5a:	a1 04 40 80 00       	mov    0x804004,%eax
  801d5f:	39 c2                	cmp    %eax,%edx
  801d61:	0f 82 72 ff ff ff    	jb     801cd9 <malloc+0x296>
  801d67:	eb 01                	jmp    801d6a <malloc+0x327>
								flag=1;
								break;}
			arr[i].space++;
			}
  ...
  801d69:	90                   	nop
	...
	for(int i=0;i<count2;i++){
  801d6a:	ff 45 cc             	incl   -0x34(%ebp)
  801d6d:	8b 45 cc             	mov    -0x34(%ebp),%eax
  801d70:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801d73:	0f 8c 48 ff ff ff    	jl     801cc1 <malloc+0x27e>
			if(flag)
				break;
		}
	}
	...
	int index=0;
  801d79:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
	int min=9999999;
  801d80:	c7 45 b8 7f 96 98 00 	movl   $0x98967f,-0x48(%ebp)
	for(int i=0;i<count2;i++){
  801d87:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)
  801d8e:	eb 37                	jmp    801dc7 <malloc+0x384>
		//cprintf("arr %d size is: %x\n",i,arr[i].space);
		if(arr[i].space<min){
  801d90:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  801d93:	89 d0                	mov    %edx,%eax
  801d95:	01 c0                	add    %eax,%eax
  801d97:	01 d0                	add    %edx,%eax
  801d99:	c1 e0 02             	shl    $0x2,%eax
  801d9c:	05 28 41 80 00       	add    $0x804128,%eax
  801da1:	8b 00                	mov    (%eax),%eax
  801da3:	3b 45 b8             	cmp    -0x48(%ebp),%eax
  801da6:	7d 1c                	jge    801dc4 <malloc+0x381>
			//cprintf("arr %d size is: %x\n",i,min);
			min=arr[i].space;
  801da8:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  801dab:	89 d0                	mov    %edx,%eax
  801dad:	01 c0                	add    %eax,%eax
  801daf:	01 d0                	add    %edx,%eax
  801db1:	c1 e0 02             	shl    $0x2,%eax
  801db4:	05 28 41 80 00       	add    $0x804128,%eax
  801db9:	8b 00                	mov    (%eax),%eax
  801dbb:	89 45 b8             	mov    %eax,-0x48(%ebp)
			index=i;
  801dbe:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  801dc1:	89 45 bc             	mov    %eax,-0x44(%ebp)
		}
	}
	...
	int min=9999999;
	for(int i=0;i<count2;i++){
  801dc4:	ff 45 b4             	incl   -0x4c(%ebp)
  801dc7:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  801dca:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801dcd:	7c c1                	jl     801d90 <malloc+0x34d>
			//cprintf("arr %d size is: %x\n",i,min);
  ...
  801dcf:	8b 15 2c 40 80 00    	mov    0x80402c,%edx
  801dd5:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  801dd8:	89 c8                	mov    %ecx,%eax
  801dda:	01 c0                	add    %eax,%eax
  801ddc:	01 c8                	add    %ecx,%eax
  801dde:	c1 e0 02             	shl    $0x2,%eax
  801de1:	05 20 41 80 00       	add    $0x804120,%eax
  801de6:	8b 00                	mov    (%eax),%eax
  801de8:	89 04 d5 e0 15 82 00 	mov    %eax,0x8215e0(,%edx,8)
	arr_add[count].end=arr[index].end;
  801def:	8b 15 2c 40 80 00    	mov    0x80402c,%edx
  801df5:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  ...
  801e08:	89 04 d5 e4 15 82 00 	mov    %eax,0x8215e4(,%edx,8)
	count++;
  801e0f:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801e14:	40                   	inc    %eax
  801e15:	a3 2c 40 80 00       	mov    %eax,0x80402c
  ...
  801e33:	50                   	push   %eax
  801e34:	e8 48 04 00 00       	call   802281 <sys_allocateMem>
  801e39:	83 c4 10             	add    $0x10,%esp

		for(int i=0;i<count2;i++){
  801e3c:	c7 45 b0 00 00 00 00 	movl   $0x0,-0x50(%ebp)
  801e43:	eb 78                	jmp    801ebd <malloc+0x47a>

			cprintf("arr %d start is: %x\n",i,arr[i].start);
  801e45:	8b 55 b0             	mov    -0x50(%ebp),%edx
  ...
  801e5f:	68 a4 30 80 00       	push   $0x8030a4
  801e64:	e8 4a ec ff ff       	call   800ab3 <cprintf>
  801e69:	83 c4 10             	add    $0x10,%esp
			cprintf("arr %d end is: %x\n",i,arr[i].end);
  801e6c:	8b 55 b0             	mov    -0x50(%ebp),%edx
  801e6f:	89 d0                	mov    %edx,%eax
  801e71:	01 c0                	add    %eax,%eax
  801e73:	01 d0                	add    %edx,%eax
  801e75:	c1 e0 02             	shl    $0x2,%eax
  801e78:	05 24 41 80 00       	add    $0x804124,%eax
  801e7d:	8b 00                	mov    (%eax),%eax
  801e7f:	83 ec 04             	sub    $0x4,%esp
  801e82:	50                   	push   %eax
  801e83:	ff 75 b0             	pushl  -0x50(%ebp)
  801e86:	68 b9 30 80 00       	push   $0x8030b9
  801e8b:	e8 23 ec ff ff       	call   800ab3 <cprintf>
  801e90:	83 c4 10             	add    $0x10,%esp
			cprintf("arr %d size is: %d\n",i,arr[i].space);
  801e93:	8b 55 b0             	mov    -0x50(%ebp),%edx
  801e96:	89 d0                	mov    %edx,%eax
  801e98:	01 c0                	add    %eax,%eax
  801e9a:	01 d0                	add    %edx,%eax
  801e9c:	c1 e0 02             	shl    $0x2,%eax
  801e9f:	05 28 41 80 00       	add    $0x804128,%eax
  801ea4:	8b 00                	mov    (%eax),%eax
  801ea6:	83 ec 04             	sub    $0x4,%esp
  801ea9:	50                   	push   %eax
  801eaa:	ff 75 b0             	pushl  -0x50(%ebp)
  801ead:	68 cc 30 80 00       	push   $0x8030cc
  801eb2:	e8 fc eb ff ff       	call   800ab3 <cprintf>
  801eb7:	83 c4 10             	add    $0x10,%esp
	count++;
		...
		for(int i=0;i<count2;i++){
  801eba:	ff 45 b0             	incl   -0x50(%ebp)
  801ebd:	8b 45 b0             	mov    -0x50(%ebp),%eax
  801ec0:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801ec3:	7c 80                	jl     801e45 <malloc+0x402>
			cprintf("arr %d start is: %x\n",i,arr[i].start);
			cprintf("arr %d end is: %x\n",i,arr[i].end);
			cprintf("arr %d size is: %d\n",i,arr[i].space);
			}
...
void free(void* virtual_address)
{
  ...
  801f07:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		...
		for(int i=0;i<count;i++){
  801f0a:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801f11:	eb 4b                	jmp    801f5e <free+0x60>
			if((int)v>=(int)arr_add[i].start&&(int)v<(int)arr_add[i].end){
  801f13:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f16:	8b 04 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%eax
  801f1d:	89 c2                	mov    %eax,%edx
  801f1f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801f22:	39 c2                	cmp    %eax,%edx
  801f24:	7f 35                	jg     801f5b <free+0x5d>
  801f26:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f29:	8b 04 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%eax
  801f30:	89 c2                	mov    %eax,%edx
  801f32:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801f35:	39 c2                	cmp    %eax,%edx
  801f37:	7e 22                	jle    801f5b <free+0x5d>
				start=arr_add[i].start;
  801f39:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f3c:	8b 04 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%eax
  801f43:	89 45 f4             	mov    %eax,-0xc(%ebp)
				end=arr_add[i].end;
  801f46:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f49:	8b 04 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%eax
  801f50:	89 45 e0             	mov    %eax,-0x20(%ebp)
				index=i;
  801f53:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f56:	89 45 f0             	mov    %eax,-0x10(%ebp)
				break;
  801f59:	eb 0d                	jmp    801f68 <free+0x6a>
		...
		for(int i=0;i<count;i++){
  801f5b:	ff 45 ec             	incl   -0x14(%ebp)
  801f5e:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801f63:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801f66:	7c ab                	jl     801f13 <free+0x15>
				break;
			}
		}
  ...
  801f6b:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  801f72:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801f75:	8b 04 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%eax
  801f7c:	29 c2                	sub    %eax,%edx
  801f7e:	89 d0                	mov    %edx,%eax
  801f80:	83 ec 08             	sub    $0x8,%esp
  801f83:	50                   	push   %eax
  801f84:	ff 75 f4             	pushl  -0xc(%ebp)
  801f87:	e8 d9 02 00 00       	call   802265 <sys_freeMem>
  ...
  801f92:	89 45 e8             	mov    %eax,-0x18(%ebp)
  801f95:	eb 2d                	jmp    801fc4 <free+0xc6>
			arr_add[i].start=arr_add[i+1].start;
  801f97:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801f9a:	40                   	inc    %eax
  801f9b:	8b 14 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%edx
  801fa2:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801fa5:	89 14 c5 e0 15 82 00 	mov    %edx,0x8215e0(,%eax,8)
			arr_add[i].end=arr_add[i+1].end;
  801fac:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801faf:	40                   	inc    %eax
  801fb0:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  801fb7:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801fba:	89 14 c5 e4 15 82 00 	mov    %edx,0x8215e4(,%eax,8)
  ...
  801fc4:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801fc9:	48                   	dec    %eax
  801fca:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801fcd:	7f c8                	jg     801f97 <free+0x99>
			arr_add[i].start=arr_add[i+1].start;
			arr_add[i].end=arr_add[i+1].end;
		}

		count--;
  801fcf:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801fd4:	48                   	dec    %eax
  801fd5:	a3 2c 40 80 00       	mov    %eax,0x80402c
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801fe6:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801fe9:	83 ec 04             	sub    $0x4,%esp
  801fec:	68 fc 30 80 00       	push   $0x8030fc
  801ff1:	68 18 01 00 00       	push   $0x118
  801ff6:	68 1f 31 80 00       	push   $0x80311f
  801ffb:	e8 11 e8 ff ff       	call   800811 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  802009:	68 fc 30 80 00       	push   $0x8030fc
  80200e:	68 1e 01 00 00       	push   $0x11e
  802013:	68 1f 31 80 00       	push   $0x80311f
  802018:	e8 f4 e7 ff ff       	call   800811 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  802026:	68 fc 30 80 00       	push   $0x8030fc
  80202b:	68 24 01 00 00       	push   $0x124
  802030:	68 1f 31 80 00       	push   $0x80311f
  802035:	e8 d7 e7 ff ff       	call   800811 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  802043:	68 fc 30 80 00       	push   $0x8030fc
  802048:	68 29 01 00 00       	push   $0x129
  80204d:	68 1f 31 80 00       	push   $0x80311f
  802052:	e8 ba e7 ff ff       	call   800811 <_panic>
...
void expand(uint32 newSize)
{
  ...
  802060:	68 fc 30 80 00       	push   $0x8030fc
  802065:	68 2f 01 00 00       	push   $0x12f
  80206a:	68 1f 31 80 00       	push   $0x80311f
  80206f:	e8 9d e7 ff ff       	call   800811 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  80207d:	68 fc 30 80 00       	push   $0x8030fc
  802082:	68 33 01 00 00       	push   $0x133
  802087:	68 1f 31 80 00       	push   $0x80311f
  80208c:	e8 80 e7 ff ff       	call   800811 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  80209a:	68 fc 30 80 00       	push   $0x8030fc
  80209f:	68 38 01 00 00       	push   $0x138
  8020a4:	68 1f 31 80 00       	push   $0x80311f
  8020a9:	e8 63 e7 ff ff       	call   800811 <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  8020c0:	8b 5d 14             	mov    0x14(%ebp),%ebx
  8020c3:	8b 7d 18             	mov    0x18(%ebp),%edi
  8020c6:	8b 75 1c             	mov    0x1c(%ebp),%esi
  8020c9:	cd 30                	int    $0x30
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  8020f7:	e8 b2 ff ff ff       	call   8020ae <syscall>
...
sys_cgetc(void)
{
  ...
  802111:	e8 98 ff ff ff       	call   8020ae <syscall>
  802116:	83 c4 18             	add    $0x18,%esp
}
  802119:	c9                   	leave  
  80211a:	c3                   	ret    

0080211b <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  80212c:	e8 7d ff ff ff       	call   8020ae <syscall>
...
int32 sys_getenvid(void)
{
  ...
  802145:	e8 64 ff ff ff       	call   8020ae <syscall>
...
int32 sys_getenvindex(void)
{
  ...
  80215e:	e8 4b ff ff ff       	call   8020ae <syscall>
...
int32 sys_getparentenvid(void)
{
  ...
  802177:	e8 32 ff ff ff       	call   8020ae <syscall>
  80217c:	83 c4 18             	add    $0x18,%esp
}
  80217f:	c9                   	leave  
  802180:	c3                   	ret    

00802181 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  80218e:	6a 06                	push   $0x6
  802190:	e8 19 ff ff ff       	call   8020ae <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  8021ae:	e8 fb fe ff ff       	call   8020ae <syscall>
  8021b3:	83 c4 18             	add    $0x18,%esp
}
  8021b6:	c9                   	leave  
  8021b7:	c3                   	ret    

008021b8 <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  8021bd:	8b 75 18             	mov    0x18(%ebp),%esi
  8021c0:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  8021cf:	52                   	push   %edx
  8021d0:	50                   	push   %eax
  8021d1:	6a 08                	push   $0x8
  8021d3:	e8 d6 fe ff ff       	call   8020ae <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  8021f5:	e8 b4 fe ff ff       	call   8020ae <syscall>
  8021fa:	83 c4 18             	add    $0x18,%esp
}
  8021fd:	c9                   	leave  
  8021fe:	c3                   	ret    

008021ff <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  802210:	e8 99 fe ff ff       	call   8020ae <syscall>
  802215:	83 c4 18             	add    $0x18,%esp
}
  802218:	c9                   	leave  
  802219:	c3                   	ret    

0080221a <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  802227:	6a 0b                	push   $0xb
  802229:	e8 80 fe ff ff       	call   8020ae <syscall>
  80222e:	83 c4 18             	add    $0x18,%esp
}
  802231:	c9                   	leave  
  802232:	c3                   	ret    

00802233 <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  802242:	e8 67 fe ff ff       	call   8020ae <syscall>
  802247:	83 c4 18             	add    $0x18,%esp
}
  80224a:	c9                   	leave  
  80224b:	c3                   	ret    

0080224c <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  802259:	6a 0d                	push   $0xd
  80225b:	e8 4e fe ff ff       	call   8020ae <syscall>
  802260:	83 c4 18             	add    $0x18,%esp
}
  802263:	c9                   	leave  
  802264:	c3                   	ret    

00802265 <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  802274:	6a 11                	push   $0x11
  802276:	e8 33 fe ff ff       	call   8020ae <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  802292:	e8 17 fe ff ff       	call   8020ae <syscall>
...
0080229d <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  8022aa:	6a 0e                	push   $0xe
  8022ac:	e8 fd fd ff ff       	call   8020ae <syscall>
  8022b1:	83 c4 18             	add    $0x18,%esp
}
  8022b4:	c9                   	leave  
  8022b5:	c3                   	ret    

008022b6 <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  8022c4:	6a 0f                	push   $0xf
  8022c6:	e8 e3 fd ff ff       	call   8020ae <syscall>
  8022cb:	83 c4 18             	add    $0x18,%esp
}
  8022ce:	c9                   	leave  
  8022cf:	c3                   	ret    

008022d0 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  8022dd:	6a 10                	push   $0x10
  8022df:	e8 ca fd ff ff       	call   8020ae <syscall>
...
008022ea <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  8022f7:	6a 14                	push   $0x14
  8022f9:	e8 b0 fd ff ff       	call   8020ae <syscall>
...
sys_enable_interrupt()
{
  ...
  802311:	6a 15                	push   $0x15
  802313:	e8 96 fd ff ff       	call   8020ae <syscall>
...
sys_cputc(const char c)
{
  ...
  802336:	50                   	push   %eax
  802337:	6a 16                	push   $0x16
  802339:	e8 70 fd ff ff       	call   8020ae <syscall>
...
sys_clear_ffl()
{
  ...
  802351:	6a 17                	push   $0x17
  802353:	e8 56 fd ff ff       	call   8020ae <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  80236d:	50                   	push   %eax
  80236e:	6a 18                	push   $0x18
  802370:	e8 39 fd ff ff       	call   8020ae <syscall>
  802375:	83 c4 18             	add    $0x18,%esp
}
  802378:	c9                   	leave  
  802379:	c3                   	ret    

0080237a <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802389:	52                   	push   %edx
  80238a:	50                   	push   %eax
  80238b:	6a 1b                	push   $0x1b
  80238d:	e8 1c fd ff ff       	call   8020ae <syscall>
  802392:	83 c4 18             	add    $0x18,%esp
}
  802395:	c9                   	leave  
  802396:	c3                   	ret    

00802397 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8023a6:	52                   	push   %edx
  8023a7:	50                   	push   %eax
  8023a8:	6a 19                	push   $0x19
  8023aa:	e8 ff fc ff ff       	call   8020ae <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8023c4:	52                   	push   %edx
  8023c5:	50                   	push   %eax
  8023c6:	6a 1a                	push   $0x1a
  8023c8:	e8 e1 fc ff ff       	call   8020ae <syscall>
...
008023d3 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  8023df:	8b 4d 14             	mov    0x14(%ebp),%ecx
  8023e2:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  8023f0:	50                   	push   %eax
  8023f1:	6a 1c                	push   $0x1c
  8023f3:	e8 b6 fc ff ff       	call   8020ae <syscall>
  8023f8:	83 c4 18             	add    $0x18,%esp
}
  8023fb:	c9                   	leave  
  8023fc:	c3                   	ret    

008023fd <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  80240c:	52                   	push   %edx
  80240d:	50                   	push   %eax
  80240e:	6a 1d                	push   $0x1d
  802410:	e8 99 fc ff ff       	call   8020ae <syscall>
  802415:	83 c4 18             	add    $0x18,%esp
}
  802418:	c9                   	leave  
  802419:	c3                   	ret    

0080241a <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  80242b:	52                   	push   %edx
  80242c:	50                   	push   %eax
  80242d:	6a 1e                	push   $0x1e
  80242f:	e8 7a fc ff ff       	call   8020ae <syscall>
  802434:	83 c4 18             	add    $0x18,%esp
}
  802437:	c9                   	leave  
  802438:	c3                   	ret    

00802439 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  802448:	52                   	push   %edx
  802449:	50                   	push   %eax
  80244a:	6a 1f                	push   $0x1f
  80244c:	e8 5d fc ff ff       	call   8020ae <syscall>
  802451:	83 c4 18             	add    $0x18,%esp
}
  802454:	c9                   	leave  
  802455:	c3                   	ret    

00802456 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  802463:	6a 20                	push   $0x20
  802465:	e8 44 fc ff ff       	call   8020ae <syscall>
  80246a:	83 c4 18             	add    $0x18,%esp
}
  80246d:	c9                   	leave  
  80246e:	c3                   	ret    

0080246f <sys_create_env>:
...
sys_run_env(int32 envId)
{
  ...
  80249b:	50                   	push   %eax
  80249c:	6a 22                	push   $0x22
  80249e:	e8 0b fc ff ff       	call   8020ae <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8024b7:	50                   	push   %eax
  8024b8:	6a 23                	push   $0x23
  8024ba:	e8 ef fb ff ff       	call   8020ae <syscall>
...
sys_get_virtual_time()
{
  ...
  8024ce:	8d 50 04             	lea    0x4(%eax),%edx
  8024d1:	8d 45 f8             	lea    -0x8(%ebp),%eax
  8024d4:	6a 00                	push   $0x0
  8024d6:	6a 00                	push   $0x0
  8024d8:	6a 00                	push   $0x0
  8024da:	52                   	push   %edx
  8024db:	50                   	push   %eax
  8024dc:	6a 24                	push   $0x24
  8024de:	e8 cb fb ff ff       	call   8020ae <syscall>
  8024e3:	83 c4 18             	add    $0x18,%esp
	return result;
  8024e6:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8024e9:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8024ec:	8b 55 fc             	mov    -0x4(%ebp),%edx
  8024ef:	89 01                	mov    %eax,(%ecx)
  8024f1:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8024f4:	8b 45 08             	mov    0x8(%ebp),%eax
  8024f7:	c9                   	leave  
  8024f8:	c2 04 00             	ret    $0x4

008024fb <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  80250b:	6a 13                	push   $0x13
  80250d:	e8 9c fb ff ff       	call   8020ae <syscall>
...
uint32 sys_rcr2()
{
  ...
  802527:	e8 82 fb ff ff       	call   8020ae <syscall>
  80252c:	83 c4 18             	add    $0x18,%esp
}
  80252f:	c9                   	leave  
  802530:	c3                   	ret    

00802531 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80253d:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  802541:	6a 00                	push   $0x0
  802543:	6a 00                	push   $0x0
  802545:	6a 00                	push   $0x0
  802547:	6a 00                	push   $0x0
  802549:	50                   	push   %eax
  80254a:	6a 26                	push   $0x26
  80254c:	e8 5d fb ff ff       	call   8020ae <syscall>
...
void rsttst()
{
  ...
  802564:	6a 28                	push   $0x28
  802566:	e8 43 fb ff ff       	call   8020ae <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  80257d:	8b 55 18             	mov    0x18(%ebp),%edx
  802580:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  802584:	52                   	push   %edx
  802585:	50                   	push   %eax
  802586:	ff 75 10             	pushl  0x10(%ebp)
  802589:	ff 75 0c             	pushl  0xc(%ebp)
  80258c:	ff 75 08             	pushl  0x8(%ebp)
  80258f:	6a 27                	push   $0x27
  802591:	e8 18 fb ff ff       	call   8020ae <syscall>
...
void chktst(uint32 n)
{
  ...
  8025aa:	6a 29                	push   $0x29
  8025ac:	e8 fd fa ff ff       	call   8020ae <syscall>
...
void inctst()
{
  ...
  8025c4:	6a 2a                	push   $0x2a
  8025c6:	e8 e3 fa ff ff       	call   8020ae <syscall>
...
uint32 gettst()
{
  ...
  8025de:	6a 2b                	push   $0x2b
  8025e0:	e8 c9 fa ff ff       	call   8020ae <syscall>
  8025e5:	83 c4 18             	add    $0x18,%esp
}
  8025e8:	c9                   	leave  
  8025e9:	c3                   	ret    

008025ea <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8025fc:	e8 ad fa ff ff       	call   8020ae <syscall>
  802601:	83 c4 18             	add    $0x18,%esp
  802604:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  802607:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  80260b:	75 07                	jne    802614 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  80260d:	b8 01 00 00 00       	mov    $0x1,%eax
  802612:	eb 05                	jmp    802619 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
0080261b <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  80262b:	6a 2c                	push   $0x2c
  80262d:	e8 7c fa ff ff       	call   8020ae <syscall>
  802632:	83 c4 18             	add    $0x18,%esp
  802635:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  802638:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  80263c:	75 07                	jne    802645 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  80263e:	b8 01 00 00 00       	mov    $0x1,%eax
  802643:	eb 05                	jmp    80264a <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
0080264c <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  80265c:	6a 2c                	push   $0x2c
  80265e:	e8 4b fa ff ff       	call   8020ae <syscall>
  802663:	83 c4 18             	add    $0x18,%esp
  802666:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  802669:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  80266d:	75 07                	jne    802676 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  80266f:	b8 01 00 00 00       	mov    $0x1,%eax
  802674:	eb 05                	jmp    80267b <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
0080267d <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  80268f:	e8 1a fa ff ff       	call   8020ae <syscall>
  802694:	83 c4 18             	add    $0x18,%esp
  802697:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80269a:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  80269e:	75 07                	jne    8026a7 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  8026a0:	b8 01 00 00 00       	mov    $0x1,%eax
  8026a5:	eb 05                	jmp    8026ac <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
008026ae <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  8026bc:	6a 2d                	push   $0x2d
  8026be:	e8 eb f9 ff ff       	call   8020ae <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8026cd:	8b 5d 14             	mov    0x14(%ebp),%ebx
  8026d0:	8b 4d 10             	mov    0x10(%ebp),%ecx
  ...
  8026dd:	52                   	push   %edx
  8026de:	50                   	push   %eax
  8026df:	6a 2e                	push   $0x2e
  8026e1:	e8 c8 f9 ff ff       	call   8020ae <syscall>
...
008026ee <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8026fd:	52                   	push   %edx
  8026fe:	50                   	push   %eax
  8026ff:	6a 2f                	push   $0x2f
  802701:	e8 a8 f9 ff ff       	call   8020ae <syscall>
